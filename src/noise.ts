...
/*
 * Since I had problems importing https://github.com/xixixao/noisejs and was
 * short of time I decied to bruteforce-reimplement it in TypeScript.
 */
...
export default class Noise
{
	...
	// private weight (octaves: number): number
	// {
	// 	let amp   = 1;
	// 	let value = 0;
